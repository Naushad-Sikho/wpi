...
<head>
  ...
  <title>Unique Portable Cabins</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url();?>dashboard" class="brand-link">
      <img src="<?php echo base_url();?>assets/images/logo.jpg" alt="Unique Portable Cabins" class="brand-image elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url();?>dashboard" class="d-block">Admin</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item">
            <a href="<?php echo base_url();?>about_me" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                About Us
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>achievement" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Achievement
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>idology" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Idology
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>constitution" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Constitution
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>counter" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Counter
              </p>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="<?php echo base_url();?>login/change_password" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Change Password
              </p>
